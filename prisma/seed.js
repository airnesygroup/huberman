  ...
  try {
    await prisma.category.createMany({
      data: [
        ...
        { slug: "tech-news", title: "Tech News", icon: "fa-solid fa-newspaper" },
        ...
        { slug: "wearable-tech", title: "Wearable Technology", icon: "fa-solid fa-watch" },
        { slug: "media-communication", title: "Media & Communication", icon: "fa-solid fa-bullhorn" },
        ...
        { slug: "electrical-electronics", title: "Electrical & Electronics", icon: "fa-solid fa-bolt" },
        { slug: "computers-hardware", title: "Computers & Hardware", icon: "fa-solid fa-desktop" },
        ...
        { slug: "mechanical-industrial", title: "Mechanical & Industrial", icon: "fa-solid fa-cogs" },
        ...
        { slug: "hci", title: "Human-Computer Interaction", icon: "fa-solid fa-hand-paper" },
